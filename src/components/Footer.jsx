...
const Footer = () => {
  ...
  const socialLinks = [
    ...
    { icon: <FaLinkedin />, href: "https://www.linkedin.com/in/ayushkoche/" },
  ];
      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between md:gap-24 gap-16 mb-16">
          ...
          <div className="md:w-1/3">
            <Link to="/" className="text-2xl font-bold mb-4 inline-block">
              <span className="text-blue-500">TechTutor</span> UI
            </Link>
        ...
        <div className="border-t border-gray-800 pt-8 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="text-gray-400 text-sm">
            © {new Date().getFullYear()} TechTutor UI. All rights reserved.
          </div>
        </div>
      </div>
    </footer>
